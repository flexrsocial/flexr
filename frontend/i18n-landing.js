...
(function(){
  ...
  de: {
    ...
    'meta.description': 'FLEXR ist die Dating-App für Gym-People in Österreich: Matches nach Fitnessstudio und Umkreis. In der Beta-Phase kostenlos – die Mitgliedschaft von 5 € pro Monat ist bis auf weiteres ausgesetzt.',
    'meta.ogTitle': 'FLEXR – Dating für Gym-People in Österreich',
    'meta.ogDescription': 'Finde Menschen, die Training genauso ernst nehmen wie du – in deinem Gym und in deiner Nähe. In der Beta-Phase kostenlos.',
    'meta.ogLocale': 'de_AT',
    ...
    'hero.usp2': 'In der Beta gratis — die 5&nbsp;€/Monat sind ausgesetzt, <b>nichts wird abgebucht</b>',
    ...
    'how.step1P': 'E-Mail, Geburtsdatum, Postleitzahl, mindestens ein Foto. Kostenlos und ohne Zahlungsmittel. Danach prüfen wir einmalig, ob du mindestens 18 bist – erst dann geht es weiter, und erst dann startet dein Gratismonat.',
    'how.step2': 'Schritt 2',
    ...
    'price.eyebrow': 'Beta-Phase',
    'price.perMonth': '/ Monat',
    'price.note': 'Die Mitgliedschaft von <s>5&nbsp;€ pro Monat</s> ist bis auf weiteres ausgesetzt — für neue und für bestehende Konten.',
    'price.li1': 'Unbegrenzt swipen und matchen',
    'price.li2': 'Chat mit allen Matches',
    'price.li3': 'Kein Zahlungsmittel nötig, keine In-App-Käufe',
    'price.li4': 'Keine Mindestlaufzeit, nichts zu kündigen',
    'price.cta': 'Kostenlos starten',
    'price.p1': '<b>Solange die Beta läuft, wird nichts abgebucht.</b> Bei der Registrierung wird kein Zahlungsmittel abgefragt und keines hinterlegt, und aus dem Konto kann von selbst kein Abo werden. Du musst nichts kündigen und kannst keine Frist versäumen.',
    'price.p2': 'Wir behalten uns vor, die Mitgliedschaft später auf 5&nbsp;€ pro Monat umzustellen — angekündigt, bevor sie gilt, und ohne dass sich dein Konto von selbst in ein Abo verwandelt. Der Preis wäre dann der Endpreis; Umsatzsteuer wird nicht zusätzlich verrechnet.',
    ...
    'faq.a4': 'Derzeit nichts. Während der Beta-Phase ist die Mitgliedschaft von 5&nbsp;€ pro Monat bis auf weiteres ausgesetzt — für neue und für bestehende Konten. Sollte die Gebühr später starten, kündigen wir das vorher an; kostenpflichtig wird nichts, ohne dass du dich aktiv dafür entscheidest.',
    ...
    'beta.free': '<b>Solange die Beta läuft, kostet FLEXR nichts.</b> Die Mitgliedschaft von 5&nbsp;€ pro Monat ist bis auf weiteres ausgesetzt — für neue und für bestehende Konten. Es wird kein Zahlungsmittel abgefragt und nichts abgebucht. Wenn die Gebühr später starten soll, sagen wir das vorher an.',
  ...
  en: {
    ...
    'meta.description': 'FLEXR is the dating app for gym people in Austria: matches by gym and radius. Free during the beta – the €5 per month membership is suspended until further notice.',
    'meta.ogTitle': 'FLEXR – dating for gym people in Austria',
    'meta.ogDescription': 'Find people who take training as seriously as you do – at your gym and close to you. Free during the beta.',
    'meta.ogLocale': 'en',
    ...
    'hero.usp2': 'Free during the beta — the €5/month fee is suspended, <b>nothing is charged</b>',
    ...
    'how.step1P': 'Email, date of birth, postal code, at least one photo. Free and without a payment method. Then we check once that you are at least 18 – only then does it continue, and only then does your free month start.',
    'how.step2': 'Step 2',
    ...
    'price.note': 'The <s>€5 per month</s> membership is suspended until further notice — for new and existing accounts alike.',
    'price.li1': 'Unlimited swiping and matching',
    'price.li2': 'Chat with all your matches',
    'price.li3': 'No payment method needed, no in-app purchases',
    'price.li4': 'No minimum term, nothing to cancel',
    'price.cta': 'Start for free',
    'price.p1': '<b>For as long as the beta runs, nothing is charged.</b> No payment method is requested or stored at sign-up, and an account cannot turn into a subscription by itself. There is nothing to cancel and no deadline to miss.',
    'price.p2': 'We reserve the right to switch the membership to €5 per month later — announced before it applies, and without your account turning into a subscription by itself. That price would be the final price; VAT is not charged on top.',
    ...
    'faq.a4': 'Nothing at the moment. During the beta the €5 per month membership is suspended until further notice — for new and existing accounts alike. Should the fee start later, we announce it beforehand; nothing becomes chargeable without you actively opting in.',
    ...
    'beta.free': '<b>For as long as the beta runs, FLEXR costs nothing.</b> The €5 per month membership is suspended until further notice — for new and existing accounts alike. No payment method is requested and nothing is charged. If the fee is to start later, we will announce it beforehand.',
