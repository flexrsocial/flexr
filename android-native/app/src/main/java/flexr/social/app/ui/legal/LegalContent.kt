...
object LegalContent {
    ...
    private val faq = LegalPage(
        ...
        blocks = listOf(
            LegalBlock.Faq(
                "Was ist FLEXR?",
                "FLEXR ist eine Dating-App für Menschen, denen Training und Gym wichtig " +
                    "sind. Du findest Matches nach deinem Fitnessstudio und deiner Stadt — " +
                    "Leute in ganz Österreich, die einen ähnlichen Lifestyle leben wie du.",
            ),
            LegalBlock.Faq(
                "Was kostet FLEXR?",
            ...
            LegalBlock.Faq(
                ...
                "FLEXR ist in ganz Österreich verfügbar. Die Matches richten sich nach " +
                    "deinem Gym und deinem Umkreis — von Wien über Graz, Linz und Salzburg " +
                    "bis Innsbruck und Klagenfurt.",
            ),
            LegalBlock.Faq(
                "Wie funktioniert das Matching?",
                "Du wählst dein Gym und deinen Suchradius. FLEXR zeigt dir passende " +
                    "Profile in der Nähe. Liken sich zwei Personen gegenseitig, entsteht ein " +
                    "Match und ihr könnt im Chat schreiben.",
            ),
            LegalBlock.Faq(
                "Ist FLEXR sicher und seriös?",
                "Ja. Jedes Konto durchläuft vor der Freischaltung eine manuelle Alters- " +
                    "und Identitätsprüfung mit Verifizierungs-Selfie und amtlichem " +
                    "Lichtbildausweis. Dazu kommen eine Melde- und Blockfunktion, der " +
                    "Verifizierungshaken im Profil sowie ein automatischer Schutz im Chat, " +
                    "der Scam-Nachrichten und externe Links erkennt und entfernt.",
            ),
            LegalBlock.Faq(
                "Für wen ist FLEXR gedacht?",
                "Für alle, die Training ernst nehmen und jemanden mit ähnlichem Lifestyle " +
                    "kennenlernen wollen — egal ob Kraftsport, Functional Fitness oder " +
                    "Ausdauer, und unabhängig vom Level.",
            ),
            LegalBlock.Faq(
                "Kann ich jederzeit kündigen?",
                "Ja. Es gibt keine Mindestlaufzeit. Du kannst dein Abo jederzeit in " +
                    "deinem Konto beenden — der Zugang bleibt bis zum Ende des bezahlten " +
                    "Zeitraums aktiv.",
            ),
        ),
    )
    ...
    private val impressum = LegalPage(
        ...
        blocks = listOf(
            ...
            LegalBlock.Paragraph(
                "Julian Pachernegg\nEinzelunternehmer, Betreiber von " +
            ...
            LegalBlock.KeyValues(
                listOf(
                    "Rechtsform" to "Einzelunternehmen (nicht im Firmenbuch eingetragen)",
                    "Firmenbuchnummer" to "entfällt (nicht protokolliertes Einzelunternehmen)",
                    "UID-Nummer" to "entfällt (umsatzsteuerbefreit gem. Kleinunternehmerregelung, § 6 Abs. 1 Z 27 UStG)",
                ),
            ),
            ...
            LegalBlock.Lettered(
                listOf(
                    "Mindestalter 18 Jahre. Bei der Registrierung gibt der Nutzer sein " +
                        "Geburtsdatum an; das Alter wird serverseitig berechnet (zulässig " +
                        "sind 18–99 Jahre). Liegt es unter 18 Jahren, kann die Registrierung " +
                    ...
                    "Alters- und Identitätsprüfung vor der Freischaltung. Zusätzlich zur " +
                        ...
                        "Prüfung zu durchlaufen: Der Nutzer nimmt ein Verifizierungs-Selfie " +
                    ...
                    "Freischaltung. Der Account wird erst nach erfolgreicher Prüfung " +
                        ...
                        "anfordern oder die Registrierung ablehnen. Die Aufnahmen des " +
                        "Ausweises und die Verifizierungs-Selfie werden nach Abschluss der " +
                        "Prüfung gelöscht (Einzelheiten in der Datenschutzerklärung).",
                    "Bei begründetem Verdacht auf Falschangaben behalten wir uns die " +
                        "Sperre des Accounts vor. Bestehende Accounts können wir zur Alters- " +
                        "und Identitätsprüfung nachträglich auffordern.",
                    "Nutzung aktuell nur für Personen mit Wohnsitz/Aufenthalt in " +
                        "Österreich (Postleitzahl bei der Registrierung).",
                    "Ein Account pro Person; keine Erstellung von Fake-Profilen oder " +
                        "Profilen für Dritte.",
                ),
            ),
            ...
            LegalBlock.Lettered(
                listOf(
                    "Es gilt österreichisches Recht unter Ausschluss der " +
                        "Verweisungsnormen des IPR.",
                    "Für Verbraucher gelten die zwingenden Bestimmungen des Wohnsitzstaates.",
                    "Beschwerden richte bitte an flexr.social@proton.me. Die OS-Plattform " +
    ...
    private val sicherheit = LegalPage(
        ...
        blocks = listOf(
            ...
            LegalBlock.Bullets(
                listOf(
                    "Bleib bis dahin im Chat. Es gibt keinen guten Grund, sofort auf " +
                        "WhatsApp, Telegram oder Instagram wechseln zu müssen. Wer darauf " +
                        "drängt, will meist raus aus einem Bereich, in dem du melden und " +
                        "blockieren kannst.",
                    "Sieh dir das Profil genau an: nur ein Foto, auffällig professionelle " +
                        "Aufnahmen, keine Angaben zum Studio — das muss nichts heißen, ist " +
                        "aber ein Grund, genauer hinzusehen. Der Verifizierungshaken " +
                        "bedeutet, dass wir ein live aufgenommenes Selfie mit den Profilfotos " +
                        "verglichen haben.",
            ...
            LegalBlock.Bullets(
                listOf(
                    "Trefft euch öffentlich — im Studio, im Café, im Park. Nicht bei dir " +
                        "oder bei der anderen Person zuhause.",
                    "Komm und geh selbstständig. Lass dich beim ersten Mal nicht abholen " +
                        "und gib deine Adresse noch nicht heraus.",
                    "Behalte Getränk und Handy bei dir und achte auf einen geladenen Akku.",
                    "Trink in Maßen — du willst klar entscheiden können, wie der Abend " +
                        "weitergeht.",
            ...
            LegalBlock.Bullets(
                listOf(
                    ...
                    "Nie erreichbar: Videocalls scheitern immer, Treffen platzen " +
                        "kurzfristig, die Person arbeitet „auf einer Bohrinsel\" oder „im " +
                        "Auslandseinsatz\".",
                    "Intime Aufnahmen: Wer schnell Nacktbilder will, will sie manchmal, " +
                        "um dich damit zu erpressen (Sextortion).",
            ...
            LegalBlock.Bullets(
                listOf(
                    "Blockieren wirkt sofort und beidseitig: Das Match verschwindet, " +
                        "Nachrichten sind nicht mehr möglich, ihr seht euch nicht mehr im " +
                        "Deck.",
                    "Melden geht in jedem Profil und in jedem Chat. Du bekommst ein " +
                        "Aktenzeichen, wir prüfen binnen 72 Stunden — bei Gefahr für eine " +
                        "Person sofort — und du siehst das Ergebnis unter „Meine Meldungen\".",
            ...
            LegalBlock.Bullets(
                listOf(
                    "Jedes Foto wird von einem Menschen geprüft, bevor es jemand zu sehen " +
                        "bekommt.",
    ...
    private val nutzungsrichtlinien = LegalPage(
        ...
        blocks = listOf(
            ...
            LegalBlock.Bullets(
                listOf(
                    "FLEXR ist ausschließlich für Personen ab 18 Jahren. Das Geburtsdatum " +
                        "wird bei der Registrierung serverseitig geprüft; Konten unter 18 " +
                        "Jahren werden technisch nicht angelegt.",
                    "Ein Konto pro Person. Konten dürfen nicht geteilt, verkauft, " +
                        "vermietet oder für Dritte betrieben werden.",
                    "Alle Angaben im Profil müssen der Wahrheit entsprechen und die " +
                        "eigene Person betreffen.",
                    "Jedes hochgeladene Foto muss die anmeldende Person selbst zeigen. " +
                        "Fotos Dritter, Prominenter, aus dem Internet oder von Minderjährigen " +
                        "sind unzulässig.",
                    "FLEXR ist eine Kontaktplattform, kein Marktplatz. Kommerzielle " +
                        "Angebote, Werbung, Anwerbung und Vermittlung jeder Art sind " +
                        "untersagt.",
                ),
            ),
            ...
            LegalBlock.Bullets(
                listOf(
                    "Menschenhandel, Zwangsprostitution, sexuelle Ausbeutung sowie jede " +
                        "Form der Anwerbung dafür (Abschnitt 4).",
                    "Alle sonstigen strafbaren Handlungen, insbesondere Betrug, " +
                        "Erpressung, Sextortion, Drogen- und Waffenhandel, Geldwäsche " +
                        "(Abschnitt 5).",
                    "Identitätsmissbrauch, Fake-Profile, Auftreten im Namen einer anderen " +
                        "realen oder juristischen Person (Abschnitt 6).",
                    "Darstellungen sexuellen Kindesmissbrauchs (CSAM) und jede " +
                        "Sexualisierung Minderjähriger (Abschnitt 7).",
                    "Belästigung, Stalking, Drohungen, Hassrede, Diskriminierung.",
                    "Weitergabe fremder personenbezogener Daten oder von Chatinhalten " +
                        "Dritter ohne deren Einwilligung.",
                    ...
                    "Automatisierter Zugriff (Bots, Scraper) sowie Umgehung von Sperren, " +
                        "etwa durch Neuanmeldung nach einem Ausschluss.",
                ),
            ),
            ...
            LegalBlock.Bullets(
                listOf(
                    "Verboten: das Anbieten, Bewerben, Vermitteln oder Nachfragen " +
                        "sexueller Handlungen gegen Geld oder geldwerte Leistungen.",
                    "Verboten: das Anwerben von Personen für Prostitution, Cam-Angebote, " +
                        "Escort-, Sugar- oder Modelagenturen, auch als vorgebliches " +
                        "Jobangebot.",
                    "Verboten: das Betreiben eines Profils für oder unter der Kontrolle " +
                        "einer anderen Person (Betreuer, Manager, Agentur).",
                    "Verboten: jede Kommunikation, die auf Zwang, Schuldknechtschaft, " +
                        "Einbehalten von Ausweisdokumenten, Isolation oder Transport zum " +
                        "Zweck der Ausbeutung hindeutet.",
                ),
            ),
            LegalBlock.Paragraph(
            ...
            LegalBlock.Lettered(
                listOf(
                    "Sofortmaßnahme innerhalb von 24 Stunden nach Kenntnis: Konto " +
                        "gesperrt, Profil nicht mehr sichtbar, laufende Chats unterbunden.",
                    "Beweissicherung: Profil, Fotos, Chatverlauf und Zeitstempel werden " +
                        "vor der Löschroutine gesichert.",
                    "Manuelle Bewertung durch den Betreiber anhand des gesicherten Materials.",
                    "Bei erhärtetem Verdacht: Anzeige bei der zuständigen " +
                        "österreichischen Strafverfolgungsbehörde (Bundeskriminalamt, " +
                        "Zentralstelle zur Bekämpfung der Schlepperkriminalität und des " +
                        "Menschenhandels) und endgültige Löschung des Kontos.",
                    "Bei akuter Gefahr für eine Person: unverzüglich Polizeinotruf 133 " +
                        "bzw. 112.",
            ...
            LegalBlock.Bullets(
                listOf(
                    "Verboten: Betrug jeder Art, insbesondere Romance Scam, " +
                        "Vorschussbetrug, angebliche Notlagen mit Geldforderung, gefälschte " +
                        "Investment- und Krypto-Angebote, Weiterleitung auf Phishing-Seiten.",
                    "Verboten: Erpressung und Sextortion, also das Androhen der " +
                        "Veröffentlichung intimer Aufnahmen.",
                    "Verboten: Handel mit Betäubungsmitteln, Waffen, gestohlenen Daten " +
                        "oder gefälschten Dokumenten.",
                    "Verboten: Geldwäsche, Weiterleitung von Zahlungen für Dritte, " +
                        "Missbrauch der Plattform zur Anbahnung von Finanztransaktionen.",
            ...
            LegalBlock.Lettered(
                listOf(
                    ...
                    "Abgestufte Maßnahme: befristete Chat-Sperre bei einmaligem, " +
                        "leichterem Verstoß — sofortige Kontosperre bei Betrugs-, " +
                        "Erpressungs- oder Handelsversuchen.",
                    ...
                    "Geschädigte erhalten auf Anfrage die zu ihrem Fall gehörenden Daten " +
                        "für eine eigene Anzeige, soweit datenschutzrechtlich zulässig.",
                ),
            ),
            ...
            LegalBlock.Bullets(
                listOf(
                    ...
                    "Verboten: das Anlegen von Zweit- oder Ersatzkonten, insbesondere " +
                        "nach einer Sperre.",
                ),
            ),
            LegalBlock.Paragraph(
            ...
            LegalBlock.Lettered(
                listOf(
                    ...
                    "Prüfung binnen 72 Stunden. Beanstandete Fotos werden für die Dauer " +
                        "der Prüfung aus der Auslieferung genommen.",
                    "Bei begründetem Verdacht fordern wir eine Foto-Verifizierung nach " +
                        "dem oben beschriebenen Verfahren an.",
                    "Wird sie nicht binnen sieben Tagen erbracht oder besteht sie die " +
                        "Prüfung nicht, werden die Fotos entfernt und das Konto gesperrt.",
                    "Bei gewerbsmäßigem oder wiederholtem Identitätsmissbrauch folgen " +
                        "endgültige Löschung und, bei Anhaltspunkten für Betrug, eine " +
                        "Anzeige.",
                ),
            ),
            ...
            LegalBlock.Bullets(
                listOf(
                    ...
                    "Verboten: das Anbahnen sexueller Kontakte zu Minderjährigen " +
                        "(Grooming) sowie das Erfragen oder Anbieten entsprechender Inhalte.",
            ...
            LegalBlock.Lettered(
                listOf(
                    ...
                    "Beweissicherung: Das Material wird gegen automatische Löschung " +
                        "gesperrt, der Zugriff auf den Betreiber beschränkt und " +
                        "ausschließlich zur Weitergabe an die Strafverfolgung aufbewahrt. Es " +
                        "wird nicht weiter angesehen, kopiert oder verbreitet.",
                    "Meldung binnen 24 Stunden nach Kenntnis an das Bundeskriminalamt, " +
                        "Meldestelle für Kinderpornografie und Kindersextourismus, und " +
                        "Anzeige bei der Kriminalpolizei. Bei akuter Gefahr für ein Kind " +
                        "zusätzlich sofort Polizeinotruf 133 bzw. 112.",
                    ...
                    "Bei einem Konto, das eine minderjährige Person betreibt: Sperre und " +
                        "Löschung; die Daten werden nur so lange aufbewahrt, wie es zur " +
                        "Erfüllung einer behördlichen Anordnung erforderlich ist.",
                ),
            ),
            LegalBlock.Paragraph(
            ...
            LegalBlock.Bullets(
                listOf(
                    "In der App: Melden- und Blockieren-Funktion in jedem Profil und in " +
                        "jedem Chat. Blockieren wirkt sofort und beidseitig.",
                    "Per E-Mail: flexr.social@proton.me, auch ohne eigenes Konto — etwa " +
                        "wenn die eigene Identität hier missbraucht wird.",
                ),
            ),
            LegalBlock.Lettered(
                listOf(
                    ...
                    "Prüfung binnen 72 Stunden — bei Gefahr im Verzug sowie in den Fällen " +
                        "der Abschnitte 4 und 7 unverzüglich, spätestens binnen 24 Stunden. " +
                        "Es prüft ein Mensch; kein Automatismus entscheidet über eine Sperre.",
                    "Entscheidung mit Begründung: Unter „Meine Meldungen\" im " +
                        "Konto-Bereich steht zu jeder Meldung, ob wir eingeschritten sind " +
                        "oder keinen Verstoß feststellen konnten — samt Begründung im " +
                        "Wortlaut.",
                    "Widerspruch: Wer mit der Entscheidung nicht einverstanden ist, kann " +
                        "ihr formlos per E-Mail widersprechen. Wir prüfen erneut und " +
                        "antworten begründet.",
                ),
            ),
            LegalBlock.Paragraph(
    ...
    private val strafverfolgung = LegalPage(
        ...
        blocks = listOf(
            ...
            LegalBlock.Bullets(
                listOf(
                    "Ersuchende Behörde, Aktenzeichen, Name und dienstliche Kontaktdaten " +
                        "der sachbearbeitenden Person.",
            ...
            LegalBlock.Bullets(
                listOf(
                    ...
                    "Behörden anderer EU-Mitgliedstaaten: über die justizielle " +
                        "Zusammenarbeit, insbesondere die Europäische Ermittlungsanordnung, " +
                        "sowie die europäische Herausgabeanordnung (Verordnung (EU) " +
                        "2023/1543), sobald anwendbar.",
                    "Behörden aus Drittstaaten: über den Rechtshilfeweg (MLAT) unter " +
                        "Einbindung der österreichischen Justizbehörden.",
                    "Freiwillige Auskünfte über die gesetzlichen Pflichten hinaus " +
                        "erteilen wir nicht — ausgenommen Notfälle nach Abschnitt 6.",
                ),
            ),
            ...
            LegalBlock.Bullets(
                listOf(
                    ...
                    "Wir bearbeiten Notfallanfragen vorrangig, können als " +
                        "Einzelunternehmen aber keinen Rund-um-die-Uhr-Bereitschaftsdienst " +
                        "zusichern.",
                ),
            ),
            ...
            LegalBlock.Lettered(
                listOf(
                    "Ersuchen per E-Mail mit Betreff Sicherung, unter Angabe des Kontos " +
                        "und des Zeitraums.",
            ...
            LegalBlock.Bullets(
                listOf(
                    "Gelöschte Konten werden sofort deaktiviert und nach 30 Tagen " +
                        "Karenzzeit endgültig gelöscht, einschließlich der Fotos im " +
                        "Objektspeicher. Danach sind die Daten nicht wiederherstellbar.",
            ...
            LegalBlock.Bullets(
                listOf(
                    "Eingangsbestätigung in der Regel binnen drei Werktagen, Notfälle " +
                        "vorrangig.",
                    "Auskünfte erteilen wir schriftlich in strukturierter Form (Text oder " +
                        "CSV).",
                    "Für die Bearbeitung stellen wir keine Kosten in Rechnung.",
                    "Wir prüfen jedes Ersuchen auf Zuständigkeit, Rechtsgrundlage und " +
                        "Verhältnismäßigkeit und widersprechen offensichtlich unzulässigen " +
                        "oder unverhältnismäßig weiten Ersuchen.",
                ),
            ),
        ),
    )
        ...
        blocks = listOf(
            ...
            LegalBlock.Paragraph(
                "Die App setzt keine Analyse- oder Werbe-SDKs ein. Der Login-Token und " +
                    ...
                    "ausschließlich lokal auf dem Gerät gespeichert, vom Cloud-Backup " +
                    "ausgenommen und beim Deinstallieren gelöscht.",
            ),
        ),
    )
}
