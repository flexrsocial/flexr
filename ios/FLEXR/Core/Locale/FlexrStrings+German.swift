...
extension FlexrStrings {
    ...
    static let german: [L: String] = [
        ...
        // MARK: Passwort vergessen / Zugangsdaten
        .loginForgot: "Passwort vergessen?",
        .forgotTitle: "Neues Passwort anfordern",
        .forgotSub: "Gib die E-Mail-Adresse deines Kontos ein. Wir schicken dir einen Link, mit dem du im Browser ein neues Passwort festlegst.",
        .forgotDone: "Falls es zu dieser Adresse ein Konto gibt, ist der Link unterwegs. Er gilt 60 Minuten. Schau auch im Spam-Ordner nach und melde dich danach hier mit dem neuen Passwort an.",
        .forgotSend: "Link schicken",
        .forgotErrEmail: "Bitte eine gültige E-Mail-Adresse eingeben.",
        .forgotErrSend: "Der Link konnte nicht angefordert werden. Bitte versuche es später erneut.",
        .resetNewPw: "Neues Passwort",
        .resetErrShort: "Das Passwort muss mindestens 8 Zeichen haben.",
        .resetErrSave: "Das hat nicht geklappt. Bitte versuche es erneut.",
        .credSection: "Zugangsdaten",
        .credEmailLabel: "E-Mail: %@",
        .credUnconfirmed: "noch nicht bestätigt",
        .credChangeEmail: "E-Mail-Adresse ändern",
        .credChangePw: "Passwort ändern",
        .credNewEmail: "Neue E-Mail-Adresse",
        .credCurrentPw: "Aktuelles Passwort",
        .credSave: "Speichern",
        .credErrPw: "Bitte dein aktuelles Passwort eingeben.",
        .credEmailDone: "Gespeichert. Bitte bestätige %@ über den Link in der Mail.",
        .credPwDone: "Passwort geändert. Alle anderen Anmeldungen wurden beendet.",
        ...
        .gymLockInfoTitle: "Gym ändern",
        .gymLockInfoBody: "Du kannst dein Gym alle 3 Monate ändern.",
