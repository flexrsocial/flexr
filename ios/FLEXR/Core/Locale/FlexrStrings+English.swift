...
extension FlexrStrings {
    ...
    static let english: [L: String] = [
        ...
        // MARK: Forgot password / sign-in details
        .loginForgot: "Forgot password?",
        .forgotTitle: "Request a new password",
        .forgotSub: "Enter the email address of your account. We will send you a link to choose a new password in your browser.",
        .forgotDone: "If there is an account for this address, the link is on its way. It is valid for 60 minutes. Check your spam folder too, then sign in here with your new password.",
        .forgotSend: "Send link",
        .forgotErrEmail: "Please enter a valid email address.",
        .forgotErrSend: "The link could not be requested. Please try again later.",
        .resetNewPw: "New password",
        .resetErrShort: "The password must have at least 8 characters.",
        .resetErrSave: "That did not work. Please try again.",
        .credSection: "Sign-in details",
        .credEmailLabel: "Email: %@",
        .credUnconfirmed: "not confirmed yet",
        .credChangeEmail: "Change email address",
        .credChangePw: "Change password",
        .credNewEmail: "New email address",
        .credCurrentPw: "Current password",
        .credSave: "Save",
        .credErrPw: "Please enter your current password.",
        .credEmailDone: "Saved. Please confirm %@ via the link in the email.",
        .credPwDone: "Password changed. All other sessions have been signed out.",
