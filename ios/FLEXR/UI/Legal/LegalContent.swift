    ...
    private static let faq = LegalPage(
        ...
        blocks: [
            .faq(
                ...
                answer: "FLEXR ist eine Dating-App für Menschen, denen Training und Gym wichtig sind. "
            ...
            .faq(
                ...
                answer: "Du testest FLEXR einen Monat gratis. Danach kostet es 5 € pro Monat, jederzeit "
                    + "kündbar — ohne Mindestlaufzeit."
            ),
            .faq(
                question: "In welchen Städten ist FLEXR verfügbar?",
                answer: "FLEXR ist in ganz Österreich verfügbar. Die Matches richten sich nach deinem Gym "
                    + "und deinem Umkreis — von Wien über Graz, Linz und Salzburg bis Innsbruck und "
                    + "Klagenfurt."
            ),
            .faq(
                question: "Wie funktioniert das Matching?",
                answer: "Du wählst dein Gym und deinen Suchradius. FLEXR zeigt dir passende Profile in der "
            ...
            .faq(
                ...
                answer: "Für alle, die Training ernst nehmen und jemanden mit ähnlichem Lifestyle "
                    + "kennenlernen wollen — egal ob Kraftsport, Functional Fitness oder Ausdauer, und "
                    + "unabhängig vom Level."
            ),
            .faq(
                question: "Kann ich jederzeit kündigen?",
                answer: "Ja. Es gibt keine Mindestlaufzeit. Du kannst dein Abo jederzeit in deinem Konto "
        ...
        blocks: [
            ...
            .paragraph(
                "Die App setzt keine Analyse- oder Werbe-SDKs ein. Der Login-Token und ein zufällig "
                    ...
                    + "dem Gerät gespeichert, vom Backup ausgenommen und beim Deinstallieren gelöscht."
            ),
        ]
    )
}
